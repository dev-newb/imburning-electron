...
- **Alerts** — burn-spike (median+MAD baseline; `BURN_PAIR_MAX_GAP_MS` tracks `refreshInterval*2.5`), warn/danger/maxed thresholds, daily digest, ntfy/webhook phone alerts (`sendAlertWebhook`; the only outbound of user data, opt-in).
