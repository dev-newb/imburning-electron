...
Get up and running with **I'm Burning!** in a couple of minutes. I'm Burning! is a small desktop
...
## Step 1: Get I'm Burning!

### Windows (prebuilt)

Go to [Releases](https://github.com/dev-newb/imburning-electron/releases) and download the latest:
...
Run the file. That's it — the installer sets up I'm Burning! and a Start Menu shortcut, and it
...
Anthropic section. This is only the first provider — I'm Burning! is not Claude-only.

Open **Settings (⚙️)** to connect the rest:

- **Anthropic** — sign in with your claude.ai session.
- **OpenAI** — "Sign in with ChatGPT" (OAuth), or let I'm Burning! read your local `codex` CLI login.
- **Google** — "Sign in with Google" (OAuth), or let I'm Burning! read your local `gemini` CLI login.
...
Once connected, I'm Burning! shows your usage per connected account: current-window and
...
I'm Burning! shows **per-company colored badges** in the tray so you can read usage at a glance —
...
- **Questions & bugs:** open a [Discussion](https://github.com/dev-newb/imburning-electron/discussions)
  or an [Issue](https://github.com/dev-newb/imburning-electron/issues)
