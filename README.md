...
- 🔥🚨 **Bars catch fire under burn alerts** *(2.3)* — when the burn detector notices a pool eating tokens unusually fast, that pool's percentage bar wears a live flame **in its own colour** (threshold recolours and Gemini shades included) until the pace settles back below half the trigger. Codex's banked reset orbs idle with a faint teal flame of their own.
